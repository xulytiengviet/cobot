...
function releaseCamera(){
 ...
 $('cameraPlaceholder').style.display='flex';$('calibrate').disabled=true;$('retryAI').hidden=true;
 status('CHƯA BẬT');const c=$('overlay');c.getContext('2d').clearRect(0,0,c.width,c.height);
}
